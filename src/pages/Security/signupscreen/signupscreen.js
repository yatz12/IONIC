...
var Signupscreen = (function () {
    function Signupscreen(navCtrl, navParams) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
    }
    Signupscreen.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad Signupscreen');
    };
    Signupscreen.prototype.Login = function () {
        this.navCtrl.setRoot('Logscreen');
    };
    Signupscreen.prototype.signup = function () {
        this.navCtrl.push('Signup');
    };
    Signupscreen.prototype.signup1 = function () {

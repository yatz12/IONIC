 ...
 */
var Bidcategorydetail = (function () {
    function Bidcategorydetail(navCtrl, navParams) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.categoryjobs = this.navParams.get('categoryjobs');
    }
    Bidcategorydetail.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad Bidcategorydetail');
    };
    Bidcategorydetail.prototype.categorytap = function (i) {
    ...
    return Bidcategorydetail;
}());
Bidcategorydetail = __decorate([
    IonicPage({
...
export { Bidcategorydetail };
//# sourceMappingURL=bidcategorydetail.js.map